...
export function OpenAppButton({ partidoId }: { partidoId?: string }) {
  function openApp() {
  ...
  return (
    <button onClick={openApp} className="rounded-full bg-[#ff6b00] px-5 py-3 text-sm font-black text-white shadow-sm hover:bg-[#d95600]">
      Abrir en Juol
    </button>
  );
}
